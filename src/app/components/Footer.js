...
import { Linkedin } from "lucide-react"; // Optional if you prefer using lucide-react for icons
  ...
  return (
    <footer className="w-full">
      <div
        ...
        style={{
          backgroundImage: "url('/footer.png')", // Reference to footer.png in the public folder
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start pt-8 sm:pt-12 md:pt-16">
            ...
            <div className="mb-6 sm:mb-8 md:mb-0 mt-12 sm:mt-16 md:mt-24">
              <Image
                src="/ASOWin.png" // Reference to ASOWin.png in the public folder
                alt="ASOWin Logo"
                width={200} // Adjust as needed
                height={100} // Adjust as needed to maintain aspect ratio
